...
export const anotherReducer = (state: Another, action: Action): Another => {
    switch (action.type) {
        case "CREATE_PRODUCT":
            return {
                ...state,
...
export const countReducer = (state: Counter, action: Action): Counter => {
    switch (action.type) {
        case "increment":
            return {
                count: state.count + 1,
...
export const showReducer = (state: Show, action: Action): Show => {
    switch (action.type) {
        case "FETCH_DATA":
